...
- Updated roles function file, removed all default roles and added custom roles with permissions
- Added database function file, added custom database table for candidates
